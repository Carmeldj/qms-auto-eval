...
export const documentTemplates: DocumentTemplate[] = [
  // Organisation et RH
  {
    ...
    fields: [
      ...
      { id: 'adjoint', label: 'Pharmacien adjoint', type: 'text', required: false, placeholder: 'Nom de l\'adjoint (si applicable)' },
      { id: 'preparateur1', label: 'Préparateur 1', type: 'text', required: false, placeholder: 'Nom du préparateur' },
      { id: 'preparateur2', label: 'Préparateur 2', type: 'text', required: false, placeholder: 'Nom du préparateur' },
      { id: 'vendeur1', label: 'Vendeur/Assistant 1', type: 'text', required: false, placeholder: 'Nom du vendeur' },
      { id: 'vendeur2', label: 'Vendeur/Assistant 2', type: 'text', required: false, placeholder: 'Nom du vendeur' },
