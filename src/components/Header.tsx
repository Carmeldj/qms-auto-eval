    ...
    >
      <div className="max-w-7xl mx-auto">
        <div className="w-full flex justify-between items-center py-3">
          <div
            className="w-48 flex items-center space-x-2 pl-4 cursor-pointer"
            onClick={() => navigate("/")}
          >
            ...
            <img src="/logo.png" alt="PHARMA QMS" className="" />
          </div>
          ...
          {isAuthenticated ? (
            <>
                ...
                {isSubscriptionLoading ? (
                  ...
                  navItems.map((item) => {
                    ...
                    const isActive =
                      ...
                      (item.id === "home" &&
                        (location.pathname === "/swot" ||
                          location.pathname === "/pestel"));
              ...
              <div
                className="lg:hidden p-4 rounded-lg cursor-pointer relative"
              ...
              <div
                className="md:hidden absolute top-24 right-0 z-50 w-full"
