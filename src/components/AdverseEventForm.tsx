...
import { X, Download, AlertCircle, CheckCircle, Mail, Loader2, FileText, Edit2 } from 'lucide-react';
import {
  NotifierInfo,
  PatientInfo,
  MedicalHistory,
...
const AdverseEventForm: React.FC<AdverseEventFormProps> = ({ onCancel }) => {
  ...
  const [customTitle, setCustomTitle] = useState<string>('FICHE DE NOTIFICATION D\'EVÉNEMENTS INDÉSIRABLES');
