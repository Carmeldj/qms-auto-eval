...
interface WasteManagementModuleProps {
  onBack: () => void;
}

export default function WasteManagementModule({ onBack }: WasteManagementModuleProps) {
  ...
  const generatePDF = (entries: PharmaceuticalWasteEntry[]) => {
    ...
    doc.text('Liste des Périmés Pharmaceutiques', 148, 15, { align: 'center' });
    ...
    doc.save(`perimes_pharmaceutiques_${startDate}_${endDate}.pdf`);
  };
      ...
      <div className="max-w-[1800px] mx-auto">
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-6 sm:mb-8 gap-4">
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            <h1 className="text-xl sm:text-2xl lg:text-3xl font-bold text-gray-800">Liste des Périmés Pharmaceutiques</h1>
          </div>
          <button
