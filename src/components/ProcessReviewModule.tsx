...
import { X, Download, Plus, Trash2, CheckCircle } from 'lucide-react';
...
const ProcessReviewModule: React.FC = () => {
        ...
        <div className="max-w-5xl mx-auto px-4 py-8">
            ...
            <div className="flex items-center justify-between">
                <button
                    ...
                    className={`flex items-center space-x-2 px-6 py-3 rounded-lg transition-all ${currentStep === 1
                ...
                {currentStep < totalSteps ? (
                    <button
                        ...
                        className={`flex items-center space-x-2 px-6 py-3 rounded-lg transition-all ${isStepValid()
                            ? 'text-white'
