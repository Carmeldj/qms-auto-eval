...
import { Download, Home, AlertTriangle, CheckCircle, XCircle, FileText, TrendingUp, ClipboardList } from 'lucide-react';
    ...
    <div className="max-w-6xl mx-auto px-3 sm:px-4 py-4 sm:py-8">
          ...
          <div className="flex space-x-3">
            ...
            {realTimeStats.nonCompliant > 0 && (
              <button
                ...
                className="flex items-center space-x-2 bg-orange-600 text-white px-6 py-3 rounded-xl font-semibold hover:bg-orange-700 transition-all duration-200"
              >
                  ...
                  return (
                    <div key={answer.itemId} className={`border-l-4 pl-4 py-3 ${priorityColors[rec.priority]}`}>
                      <div className="flex items-start justify-between mb-2">
                        ...
                        <span className={`text-xs px-2 py-1 rounded-full ${rec.priority === 'immediate' ? 'bg-red-100 text-red-800' :
                      ...
                      <div className="flex items-center space-x-4 text-xs text-gray-500">
                        ...
                        {answer.gapType && (
                          <span className={`px-2 py-1 rounded-full text-xs ${answer.gapType === 'critical' ? 'bg-red-100 text-red-700' :
              ...
              <div key={category} className="border border-gray-200 rounded-lg p-6">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <div className="flex items-center space-x-4">
                    {answeredCount > 0 ? (
                      <span className={`px-3 py-1 rounded-full text-sm font-medium ${categoryComplianceRate >= 90 ? 'bg-green-100 text-green-800' :
                ...
                <div className="space-y-3">
                  ...
                  {categoryItems.map(item => {
                    ...
                    return (
                      <div key={item.id} className={`flex items-start space-x-3 p-3 rounded-lg ${itemAnswer ? 'bg-gray-50' : 'bg-blue-50 border border-blue-200'
                        }`}>
                        ...
                        <div className="flex-1">
                          ...
                          <div className="text-sm text-gray-600">
                            ...
                            {itemAnswer?.status === 'non-compliant' && itemAnswer.gapType && (
                              <span className={`ml-2 px-2 py-1 rounded-full text-xs ${itemAnswer.gapType === 'critical' ? 'bg-red-100 text-red-800' :
      ...
      <div className="flex justify-center space-x-4 mt-8">
        ...
        {realTimeStats.nonCompliant > 0 && (
          <button
            onClick={() => setShowActionPlan(true)}
            className="flex items-center space-x-2 bg-orange-600 text-white px-8 py-4 rounded-xl font-semibold hover:bg-orange-700 transition-all duration-200"
          >
            <ClipboardList className="h-5 w-5" />
            <span>Plan d'Action</span>
          </button>
