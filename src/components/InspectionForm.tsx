...
const InspectionForm: React.FC<InspectionFormProps> = ({ onComplete }) => {
  ...
  const [showGapClassification, setShowGapClassification] = useState<
    string | null
  >(null);
        ...
        <div className="w-full bg-gray-200 rounded-full h-2">
          <div
            ...
            style={{
              ...
              width: `${(getAnsweredCount() / inspectionItems.length) * 100}%`,
            }}
          />
        </div>
      </div>
                    ...
                    return (
                      ...
                      >
                        <input
                          ...
                          checked={isSelected}
                          onChange={() =>
                            handleAnswerChange(item.id, option.value as any)
                          }
                    ...
                    {[
                      {
                        ...
                        description:
                          "Risque significatif (ex: produit dangereux/falsifié)",
                        color: "red",
                      },
                      {
                        value: "major",
                        label: "Risque majeur",
                        description:
                          "Peut conduire à dispense de produits non conformes",
                        color: "orange",
                      },
                      {
                        value: "minor",
                        label: "Écart mineur",
                        description:
                          "Écart aux bonnes pratiques sans impact immédiat",
                        color: "yellow",
                      },
                    ].map((gap) => (
                      <label
                      ...
                      >
                        ...
                        />
                        <div>
                          <div className={`font-medium text-${gap.color}-800`}>
                            {gap.label}
                          </div>
                          <div className={`text-sm text-${gap.color}-600`}>
                            {gap.description}
                          </div>
                        </div>
                      </label>
          ...
          <div className="flex space-x-2">
            ...
            >
              ...
              <span className="text-xs ml-2">
                ({getAnsweredCount()}/{inspectionItems.length})
              </span>
            </button>
